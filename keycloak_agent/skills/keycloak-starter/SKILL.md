...
description: >-
  Keycloak API + MCP Server + A2A Server Use when working with Keycloak via this package's MCP
...
license: MIT
tags: [keycloak-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Keycloak Starter Skill

Starter skill for the **Keycloak** package. Use the `mcp-client` universal skill
